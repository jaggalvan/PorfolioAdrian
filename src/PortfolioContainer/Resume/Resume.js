...
const Resume = (props) => {
  ...
  const projectsDetails = [
    ...
    {
      title: "Backend Application Development with Node.js and Express/IBM ",
      duration: { fromDate: " ", toDate: "2024" },
      description:
    ...
    {
      title: "Desarrollo Web Con .NET CORE / IECA-UNAM León",
      duration: { fromDate: " ", toDate: "2023" },
      description:
    ...
    {
      title: "Desarrollo Web REACT / IECA-UNAM León",
      duration: { fromDate: " ", toDate: "2023" },
      description:
        "Online ecommerce website for showcasing and selling products onlne with payment system integration, both Paypal and Stripe",
      subHeading:
    ...
    {
      title: "Analista De Datos / Google",
      duration: { fromDate: " ", toDate: "2023" },
      description:
        "Online ecommerce website for showcasing and selling products onlne with payment system integration, both Paypal and Stripe",
      subHeading:
    ...
    {
      title: "Gestión de Proyectos / Google",
      duration: { fromDate: " ", toDate: "2023" },
      description:
        "Online ecommerce website for showcasing and selling products onlne with payment system integration, both Paypal and Stripe",
      subHeading:
    ...
    {
      title: "Business Intelligence / Google ",
      duration: { fromDate: " ", toDate: "2024" },
      description:
        "Online ecommerce website for showcasing and selling products onlne with payment system integration, both Paypal and Stripe",
      subHeading:
    ...
    {
      title: "Desarrollo Web con Angular/ IECA-UNAM León",
      duration: { fromDate: " ", toDate: "2024" },
      description:
        "Online ecommerce website for showcasing and selling products onlne with payment system integration, both Paypal and Stripe",
      subHeading:
    ...
    {
      title: "Comunicación Asertiva/ IECA-UNAM León",
      duration: { fromDate: " ", toDate: "2024" },
      description:
        "Online ecommerce website for showcasing and selling products onlne with payment system integration, both Paypal and Stripe",
      subHeading:
...
{/*           <br />
    ...
    /* PROJECTS */
     ...
     <div className="resume-screen-container" key="certificados">
